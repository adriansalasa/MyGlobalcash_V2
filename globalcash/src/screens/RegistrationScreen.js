...
class RegistrationScreen extends Component {
  ...
  handlerNextPage(value) {
    ...
    if (currentPage === 0) {
      ...
      if (!ename1 || !hubungan || !emobile1 || !ename2 || !hubungan2 || !emobile2) {
        Alert.alert('Mohon Lengkapi Data terlebih dahulu');
      } else {
        this.setState({
          currentPage: value,
  ...
  handlerInsertDB() {
    ...
    if (
      ...
      formData.append('nama_depan', this.state.nama_depan);
      formData.append('nama_belakang', this.state.nama_belakang);
      ...
      formData.append('erel1', this.state.hubungan);
      ...
      formData.append('erel2', this.state.hubungan2);
      ...
      formData.append('nama_rekening', this.state.nama_rekening);
      axios({
        method: 'post',
        ...
        .then(res => {
          console.log(res);
          this.props.getNasabah(this.state.mobile);
        })
        .catch(err => {
          //handle error
          console.log(err);
            ...
            <View style={styles.formWrapper}>
              ...
              {this.state.currentPage === 2 && (
                <RegFormInput3
                  ...
                  hubungan2={this.state.hubungan2}
                  handlerChangeValue={this.handlerChangeValue}
                  handlerNextPage={this.handlerNextPage}
                />
              )}
